...
def main(): 
    ...
    test_annotations    = 'data_3/test_47_com.txt'
    ...
    eval_results, acc_per_class = evaluate(torch.cat(preds),torch.cat(targets),data_cfg.get('test').get('metrics'),data_cfg.get('test').get('metric_options'))
