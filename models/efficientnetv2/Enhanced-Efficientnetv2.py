...
data_cfg = dict(
    ...
    train = dict(
        ...
        pretrained_weights = 'weights/EfficientNetv2-s/efficientnetv2-s_in21k-pre-3rdparty_in1k_20221220-7a7c8475.pth',
        freeze_flag = False,
        freeze_layers = ('backbone',),
        epoches = 100,
    ),
    test=dict(
        ckpt = 'logs/EfficientNetV2/att+mul/Last_Epoch100.pth',
